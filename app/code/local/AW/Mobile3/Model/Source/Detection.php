...
class AW_Mobile3_Model_Source_Detection
{
    const AUTO_VALUE          = 1;
    ...
    public function toOptionArray()
    {
        return array(
            array(
                ...
                'label' => Mage::helper('aw_mobile3')->__(self::AUTO_LABEL)
            ),
            array(
                'value' => self::FORCE_MOBILE_VALUE,
                'label' => Mage::helper('aw_mobile3')->__(self::FORCE_MOBILE_LABEL)
            ),
            array(
                'value' => self::FORCE_DESKTOP_VALUE,
                'label' => Mage::helper('aw_mobile3')->__(self::FORCE_DESKTOP_LABEL)
            )
        );
    }
}